...
(function () {
  ...
  _.prototype = {
    ...
    destroy() {
      ...
      const indexOfAwesomplete = _.all.indexOf(this);
    ...
    select(selected, origin, originalEvent) {
      ...
      if (selected) {
        ...
        const allowed = $.fire(this.input, 'awesomplete-select', {
          text: suggestion,
  ...
  function configure(instance, properties, o) {
    for (const i in properties) {
      ...
      const attrValue = instance.input.getAttribute(`data-${i.toLowerCase()}`);
