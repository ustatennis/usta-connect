...
export function setAWSStore() {
  ...
  const appFileStatusClientSecret = window.hlx.APP_FILE_STATUS_API_CLIENT_SECRET;
    const appSinitiEndpoint = window.hlx.APP_SINITI_API_ENDPOINT;
    const appSinitiAuthorizationEndpoint = window.hlx.APP_SINITI_AUTHORIZATION_API_ENDPOINT;
